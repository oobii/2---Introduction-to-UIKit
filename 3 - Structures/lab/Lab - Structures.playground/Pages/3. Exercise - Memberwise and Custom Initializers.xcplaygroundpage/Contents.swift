...
var favoriteBook = Book(title: "Deepness in the Sky", author: "Vernon Vinge", pages: 700, price: 11.99)
print("title: \"\(favoriteBook.title)\" by author: \(favoriteBook.author), pages: \(favoriteBook.pages), prive: \(favoriteBook.price)")
/*:
 ...
 */
var myHeight = Height(heightInCentimeters: 191)
