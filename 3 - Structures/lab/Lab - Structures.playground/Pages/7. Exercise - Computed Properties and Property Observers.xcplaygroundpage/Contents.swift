...
var smallRectangle = Rectangle(width: 10, height: 14)
...
struct Height {
    ...
    var heightInCentimeters: Double {
        didSet {
            print("heightInCentimeters was set")
...
var someHeight = Height(heightInCentimeters: 210)

someHeight.heightInCentimeters = 211
